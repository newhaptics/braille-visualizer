...
_XCFG_SECTIONS = {
	...
	"PROCG_NOISESUPPRESSION_T72": "T72",
}
...
_MANAGED_REGISTERS = {
	...
	"T72": {"NLGAINDUALX", "MINNLTHR", "INCNLTHR", "FALLNLTHR", "NLTHRMARGIN",
			"MINTHRADJ", "NLTHRLIMIT", "NLGAINSINGX", "STABCTRL", "STABHIGHNLTHR",
			"NOISCTRL", "NOISLOWNLTHR", "NOISHIGHNLTHR", "VNOICTRL", "VNOILOWNLTHR"},
}
...
_HARDCODED_FACTORY = {
	...
	"T72": {
		"NLGAINDUALX": 5, "MINNLTHR": 22, "INCNLTHR": 22, "FALLNLTHR": 5,
		"NLTHRMARGIN": 5, "MINTHRADJ": 24, "NLTHRLIMIT": 130,
		"NLGAINSINGX": 9, "STABCTRL": 7, "STABHIGHNLTHR": 12,
		"NOISCTRL": 1, "NOISLOWNLTHR": 3, "NOISHIGHNLTHR": 32,
		"VNOICTRL": 1, "VNOILOWNLTHR": 4,
	},
}
